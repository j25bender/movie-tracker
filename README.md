...
```json
  "homepage": "https://myemail.github.io/my-app",
```

or for a GitHub user page:

```json
  "homepage": "https://myemail.github.io",
```
...
To publish it at [https://myemail.github.io/my-app](https://myemail.github.io/my-app), run:
